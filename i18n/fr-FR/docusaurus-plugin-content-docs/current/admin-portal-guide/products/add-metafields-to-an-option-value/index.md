---
title: Ajouter des champs de métadonnées à une valeur d'option
sidebar_label: Ajouter des champs de métadonnées à une valeur d'option
---

# Ajouter des champs de métadonnées à une valeur d'option

## Ce que ce guide couvre

Joindre des métadonnées personnalisées à une valeur d'option pour les besoins de données spécifiques au marché ou les besoins d'intégration du système.
...
**Step 3:** Cherchez la valeur de l'option en entrant le nom, le code ou la balise de catalogue dans le champ de recherche.

**Step 4:** Cliquez sur le menu à trois points à côté de la valeur de l'option, puis sélectionnez **Meta**.
