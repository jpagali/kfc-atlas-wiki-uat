---
title: Añadir Metafields a un Variant
sidebar_label: Añadir Metafields a un Variant
---

# Añadir Metafields a un Variant

## Qué cubre esta guía

Adjunta datos estructurados específicos para el mercado a una variante de producto para la integración del sistema o los requerimientos de aguas abajo.
...
**Step 3:** Busque la variante introduciendo el Nombre del Producto, Valores de Opción o Etiquetas en el campo de búsqueda.

**Step 4:** Haga clic en el menú de tres puntos junto a la variante, luego seleccione **Meta**.
