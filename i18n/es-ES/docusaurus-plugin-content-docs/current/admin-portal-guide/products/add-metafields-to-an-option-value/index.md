---
title: Añadir Metafields a un valor de opción
sidebar_label: Añadir Metafields a un valor de opción
---

# Añadir Metafields a un valor de opción

## Qué cubre esta guía

Adjunta metadatos personalizados a un valor de opción para requisitos de datos específicos del mercado o necesidades de integración del sistema.

## Pasos

**Step 1:** Navegue a la sección **Productos** usando el menú de navegación izquierdo.

**Step 2:** Haga clic en la pestaña **Option Values**.

**Step 3:** Busque el valor de la opción introduciendo el Nombre, Código o Catalog Tag en el campo de búsqueda.

**Step 4:** Haga clic en el menú de tres puntos junto al valor de opción, luego seleccione **Meta**.
