---
title: Añadir Metafields a un peso
sidebar_label: Añadir Metafields a un peso
---

# Añadir Metafields a un peso

## Qué cubre esta guía

Adjunta metadatos personalizados a una entrada de peso para las necesidades de integración del sistema o requisitos específicos del mercado.
...
**Step 3:** Busque el peso al entrar en el Nombre de Peso o Código de Peso en el campo de búsqueda.

**Step 4:** Haga clic en el menú de tres puntos junto al peso, luego seleccione **Meta**.
