---
title: スロットにメタフィールドを追加する
sidebar_label: スロットにメタフィールドを追加する
---
...
このガイドでは、Byte Commerce Admin Portal でスロットにメタフィールドを追加する手順を説明します。
...
**ステップ 3:** You can search Slots by entering the Names or Codes or by Tags.
...
- Add/Edit/Copy/Delete Meta Data on a Slot
