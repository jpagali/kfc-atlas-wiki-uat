---
title: バリエーションにメタフィールドを追加する
sidebar_label: バリエーションにメタフィールドを追加する
---

# バリエーションにメタフィールドを追加する

## このガイドで扱う内容

このガイドでは、Byte Commerce Admin Portal でバリエーションにメタフィールドを追加する手順を説明します。

## 手順

**ステップ 1:** まず、こちらをクリックして Products 画面に移動します。

**ステップ 2:** the Variants tab をクリックします。
**ステップ 3:** You can search Variants by entering the Product Name or Option Values or by Tags.
...
**ステップ 7:** 完了したら、with your edits, click “Copy Variant Metafields” ボタン。
...
- Add/Edit/Copy/Delete Meta Data on a Variant
