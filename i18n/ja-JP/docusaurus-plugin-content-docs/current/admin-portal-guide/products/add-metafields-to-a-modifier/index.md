---
title: モディファイアにメタフィールドを追加する
sidebar_label: モディファイアにメタフィールドを追加する
---

# モディファイアにメタフィールドを追加する

## このガイドで扱う内容

このガイドでは、Byte Commerce Admin Portal でモディファイアにメタフィールドを追加する手順を説明します。
...
**ステップ 7:** 完了したら、with your edits, click “Copy Modifier Metafields” ボタン。
