---
title: オプション値にメタフィールドを追加する
sidebar_label: オプション値にメタフィールドを追加する
---
...
このガイドでは、Byte Commerce Admin Portal でオプション値にメタフィールドを追加する手順を説明します。
...
**ステップ 3:** You can search Option Values by entering the Name or Code or search by Catalog Tag.

**ステップ 4:** the 3 dots to reveal a panel. Click Edit をクリックします。

![Step 2](./img/step-2.png)

**ステップ 5:** the here to open the drawer to fill in をクリックします。
...
**ステップ 7:** When you go along filling in the info this ボタン will turn blue, click it when you are done.

**ステップ 7:** 完了したら、with your edits, click Save。

**ステップ 7:** 完了したら、with your edits, click “Copy Option Value Metafields” ボタン。
...
- Add/Edit/Copy/Delete Meta Data on an Option Value
