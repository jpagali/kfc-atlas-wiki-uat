...
Attaches market-specific structured data to a product variant for system integration or downstream requirements.
...
**Step 3:** Search for the variant by entering the Product Name, Option Values, or Tags in the search field.

**Step 4:** Click the three-dot menu next to the variant, then select **Meta**.
