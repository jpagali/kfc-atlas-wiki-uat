...
Attaches custom metadata to a weight entry for system integration needs or market-specific requirements.
...
**Step 3:** Search for the weight by entering the Weight Name or Weight Code in the search field.

**Step 4:** Click the three-dot menu next to the weight, then select **Meta**.
